...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_ordenarEnvios=function(){return xajax.request({xjxfun:'ordenarEnvios'},{parameters:arguments});};xajax_getMapa=function(){return xajax.request({xjxfun:'getMapa'},{parameters:arguments});};xajax_ocultar=function(){return xajax.request({xjxfun:'ocultar'},{parameters:arguments});};